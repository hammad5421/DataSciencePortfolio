...
image:
    src: /src/assets/mj-robot-airport-security.webp
...
![An isomorphic castle and moat rendering](/src/assets/mj-isometric-castle-and-moat.webp)
...
![A baby robot playing with blocks in a sandbox at the park. (Generated by Midjourney)](/src/assets/baby-robot-sandbox.webp)
...
![An xkcd comic where the school is calling a mom because her son's name includes SQL injection](/src/assets/xkcd-exploits-of-a-mom.png)
...
![A robot art thief repelling down from the ceiling into an art gallery](/src/assets/mj-robot-art-thief.webp)
...
![An illustration of a robot passing through a metal detector](/src/assets/mj-robot-metal-detector.webp)
